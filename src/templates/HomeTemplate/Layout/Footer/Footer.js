...
import { Facebook, Apple } from "iconsax-react";
const Footer = (props) => {
  const { heThongRapChieu } = useSelector((state) => state.ManagerCinema);
  const arrHeThongRap = _.map(heThongRapChieu, (heThongRap) =>
    _.pick(heThongRap, "maHeThongRap", "logo", "tenHeThongRap")
  );
  // console.log(arrHeThongRap, "ManagerCinema");
  return (
    <footer className="py-6 dark:bg-gray-800 dark:text-gray-50">
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium">Mobie App</p>
